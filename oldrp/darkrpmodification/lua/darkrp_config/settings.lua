...
GM.Config.DefaultLaws = {
	"Не причиняйте ущерб другим гражданам.",
	"Не взламывайте и не обкрадывайте чужие дома.",
	"Принтеры и наркотики запрещенны."
}
