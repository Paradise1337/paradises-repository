local adverts = {
	...
	{'Уважаемые игроки, просим вас соблюдать правила и вести себя адекватно на сервере, удачной игры! С ув. Администраций ExpansiveWorld', Color(115,170,105)},
	{'Рекламное место в этой строке - продается, подробности в группе ВК!', Color(185,85,85)},
}
