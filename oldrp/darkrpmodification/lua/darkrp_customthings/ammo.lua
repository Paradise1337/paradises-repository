...
GAMEMODE:AddAmmoType("ammo_338", ".338", "models/Items/BoxMRounds.mdl", 80, 10)

GAMEMODE:AddAmmoType("ammo_556x45", "5.56", "models/Items/BoxMRounds.mdl", 80, 30)

GAMEMODE:AddAmmoType("ammo_762", "7.62", "models/Items/BoxMRounds.mdl", 80, 30)

GAMEMODE:AddAmmoType("ammo_ar2", "AR2 +Impulse", "models/Items/BoxMRounds.mdl", 80, 30)

GAMEMODE:AddAmmoType("Battery", "9mm", "models/Items/BoxSRounds.mdl", 80, 30)

GAMEMODE:AddAmmoType("AlyxGun", "5.7mm", "models/Items/BoxSRounds.mdl", 80, 30)

GAMEMODE:AddAmmoType("ammo_45", ".45", "models/Items/BoxSRounds.mdl", 80, 30)

GAMEMODE:AddAmmoType("ammo_50", ".50 ACP", "models/Items/BoxSRounds.mdl", 80, 30)

GAMEMODE:AddAmmoType("337", ".337", "models/Items/BoxSRounds.mdl", 80, 30)

GAMEMODE:AddAmmoType("Buckshot", "Дробь", "models/Items/BoxBuckshot.mdl", 80, 30)